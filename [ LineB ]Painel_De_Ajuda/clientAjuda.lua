...
function DxAjuda()
	...
	if cursorPosition(x*879, y*245, x*116, y*32) then cor[18] = tocolor(0, 255, 127, 75) end
        ...
        dxDrawText("Painel Ajuda", x*358, y*190, x*1008, y*226, tocolor(255, 255, 255, 255), x*1.00, Font_1, "center", "center", false, false, false, false, false)
        ...
        dxDrawText("Fechar Painel", x*555, y*585, x*811, y*613, tocolor(255, 255, 255, 255), x*1.00, Font_3, "center", "center", false, false, false, false, false)
        ...
        dxDrawText("Ajuda", x*374, y*247, x*486, y*275, tocolor(255, 255, 255, 255), x*1.00, Font_2, "center", "center", false, false, false, false, false)
        dxDrawText("Comandos", x*500, y*247, x*613, y*275, tocolor(255, 255, 255, 255), x*1.00, Font_2, "center", "center", false, false, false, false, false)
        dxDrawText("Radio", x*627, y*247, x*739, y*275, tocolor(255, 255, 255, 255), x*1.00, Font_2, "center", "center", false, false, false, false, false)
        dxDrawText("Regras", x*754, y*247, x*866, y*275, tocolor(255, 255, 255, 255), x*1.00, Font_2, "center", "center", false, false, false, false, false)
        dxDrawText("Vendas", x*881, y*247, x*993, y*275, tocolor(255, 255, 255, 255), x*1.00, Font_2, "center", "center", false, false, false, false, false)
end
